...
function Links({ SideopenDropDown }) {
    return (
        <>
            <Link exact to="/dashboard">
                <div className="flex-content nav-card dashboard-bacground">
                    {!SideopenDropDown ? <div><span className="iconify nav-icon" data-icon="radix-icons:dashboard" data-inline="false"></span> </div> : "Icon"}
                    <div className="nav-name">Dashboard</div>
                </div>
            </Link>
            <Link exact to="/">
                <div className="flex-content nav-card dashboard-bacground">
                    {!SideopenDropDown ? <div><span className="iconify nav-icon" data-icon="la:file-invoice" data-inline="false"></span></div> : "icon"}
